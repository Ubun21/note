...
// const p = new Proxy(s, {})
// console.info(p.size)
// Set.prototype.size 是一个属性访问器,规范要去要有一个[[setData]]内部方法
// 通过代理对象p访问size的时候，this指向的是代理对象，而代理对象内部没有[[setData]]
...
// console.info(p.size)
// p.delete(1)
// // p.delete不像p.size一样会执行，因此此时通过Reflect.get，无法改变this的指向
// // p.delete()执行的时候this指向的是代理对象
// console.info(p.size)
